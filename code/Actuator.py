...
gif_dir = 'C:/Users/exam18/Desktop/Home_Automation_using_GestureRecognition-main/gifs/'
...
# 2 - 12
func_map = {
    'Thumbs_up': red_on,            # thumbs up
    'Thumbs_down': red_half_on,       # thumbs down
    'Fist': red_off,            # fist

    'Two': green_on,          # two
    'Three': green_half_on,      # three
    'Four': green_off,          # four
    ...
    'Direction_left': change_channel,     # right
    'Direction_right': change_channel,
    'Five-palm': clean_floor         # palm-five
}
