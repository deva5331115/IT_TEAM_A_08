...
checkpoint_path = 'C:/Users/exam18/Desktop/Home_Automation_using_GestureRecognition-main/TrainedModel/Gesture12RecognitionModelBest.keras'
best_checkpoint_path = 'C:/Users/exam18/Desktop/Home_Automation_using_GestureRecognition-main/TrainedModel/Gesture12RecognitionModelBest.keras'
saved_model_path = 'C:/Users/exam18/Desktop/Home_Automation_using_GestureRecognition-main/TrainedModel/Gesture12RecognitionModelBest.keras'

n_classes = len(os.listdir('C:/Users/exam18/Desktop/Home_Automation_using_GestureRecognition-main/Dataset'))
...
def getPredictedClass():
    ...
    resized_img = cv2.resize(gray_image, (100, 89)) 
    rgb_img = cv2.cvtColor(resized_img, cv2.COLOR_GRAY2RGB)
    normalized_img = rgb_img / 255.0
    input_img = np.expand_dims(normalized_img, axis=0)

    prediction = loaded_model.predict([input_img.reshape(1, 100, 89, 3)])
...
def get_labels_rev():
    ...
    gestures = []
    with open('C:/Users/exam18/Desktop/Home_Automation_using_GestureRecognition-main/preprocessing/gestures.txt', 'r') as f:
        for line in f:
            line = line.strip()
        ...
        if num_frames < 30:
            ...
            if hand is not None:
                ...
                if start_recording:
                    ...
                    sunflower_url =  Path('C:/Users/exam18/Desktop/Temp.png')
                    img_height = 100
                    img_width = 89
