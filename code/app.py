...
saved_model_path = 'Home_Automation_using_GestureRecognition-main\TrainedModel\Gesture12RecognitionModelBest.keras'
...
checkpoint_path = 'Home_Automation_using_GestureRecognition-main\TrainedModel\Gesture12RecognitionModelBest.keras'
best_checkpoint_path = 'Home_Automation_using_GestureRecognition-main\TrainedModel\Gesture12RecognitionModelBest.keras'
saved_model_path = 'Home_Automation_using_GestureRecognition-main\TrainedModel\Gesture12RecognitionModelBest.keras'

n_classes = len(os.listdir('Home_Automation_using_GestureRecognition-main\Dataset'))
dataset_dir = Path('Home_Automation_using_GestureRecognition-main\Dataset')
